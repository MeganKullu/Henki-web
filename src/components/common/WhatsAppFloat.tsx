...
export default function WhatsAppFloat() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center gap-2.5 bg-[#25D366] text-white px-4 py-3 rounded-full shadow-2xl hover:bg-[#1ebe5d] hover:scale-105 transition-all duration-200 font-semibold text-sm"
    >
      {/* WhatsApp SVG */}
